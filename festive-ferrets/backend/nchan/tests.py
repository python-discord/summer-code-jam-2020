...
class BoardsTests(TestCase):
    ...
    def test_returns_board_posts(self):
        ...
        Board.objects.create(board='01', title='test-board-01')
        Board.objects.create(board='02', title='test-board-02')
        Post.objects.create(title='first post', board=Board.objects.get(pk='01'), poster='festive-ferret', text='Lorem ipsum dolor sit amet, consectetur adipiscing elit')
        Post.objects.create(title='second post', board=Board.objects.get(pk='02'), poster='friendly-frogs', text='sed do eiusmod tempor incididunt ut labore et dolore magna aliqua')
...
class PostsTests(TestCase):
    ...
    def test_returns_all_existing_posts(self):
        ...
        Board.objects.create(board='01', title='test-board-01')
        Post.objects.create(title='first post', board=Board.objects.get(pk='01'), poster='festive-ferret', text='Lorem ipsum dolor sit amet, consectetur adipiscing elit')
        Post.objects.create(title='second post', board=Board.objects.get(pk='01'), poster='friendly-frogs', text='sed do eiusmod tempor incididunt ut labore et dolore magna aliqua')
    ...
    def test_returns_post_comments(self):
        ...
        Board.objects.create(board='01', title='test-board-01')
        Post.objects.create(title='first post', board=Board.objects.get(pk='01'), poster='festive-ferret', text='Lorem ipsum dolor sit amet, consectetur adipiscing elit')
        Comment.objects.create(post=Post.objects.get(pk=1), commenter='glossy-gorillas', text='URL namespace "admin" isn"t unique. You may not be able to reverse all URLs in this namespace')
