    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(default='Hi, I am a HoneyFeed User', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('topic_name', models.CharField(blank=True, default='', max_length=20, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_thread', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.Comment')),
