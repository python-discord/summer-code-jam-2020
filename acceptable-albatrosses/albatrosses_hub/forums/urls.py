...
urlpatterns = [
    ...
    path("user/<username>/", views.UserPostListView.as_view(),
         name='user-posts'),
    path("<board>/<int:pk>/", views.PostDetailView.as_view(),
         name='board-detail'),
    path("<board>/<int:post_pk>/<int:pk>/",
         views.CommentDetailView.as_view(), name='comment-detail'),
    path("<board>/<int:pk>/new/", views.CommentCreateView.as_view(),
         name='comment-create'),
    path("<board>/<int:post_pk>/<int:pk>/update/",
         views.CommentUpdateView.as_view(), name='comment-update'),
    path("<board>/<int:post_pk>/<int:pk>/delete/",
         views.CommentDeleteView.as_view(), name='comment-delete'),
    path("<board>/<int:pk>/update/", views.PostUpdateView.as_view(),
         name='post-update'),
    path("<board>/<int:pk>/delete/", views.PostDeleteView.as_view(),
         name='post-delete'),
