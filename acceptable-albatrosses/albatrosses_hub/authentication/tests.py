...
class AuthViewTest(TestCase):
    ...
    def test_logged_in_user_get_redirect_on_register_page(self):
        request = self.factory.get(reverse("register_page"))
    ...
    def test_registered_email_can_not_be_registered(self):
        request = self.factory.post(reverse("register_page"))
    ...
    def test_username_is_not_registered(self):
        request = self.factory.post(reverse("login_page"))
        request.user = AnonymousUser()
        request.POST = request.POST.copy()
    ...
    def test_anonymous_user_can_not_access_logout_page(self):
        request = self.factory.get(reverse("logout_page"))
        request.user = AnonymousUser()
    ...
    def test_logout(self):
        request = self.factory.post(reverse("logout_page"))
        request.user = self.user
