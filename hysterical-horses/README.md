...
7. (*optional in dev, required for full functionality*) run `docker-compose up --build` in `\hysterical-horses` to build dependencies, start redis, and start the server.
